...
SECRET_KEY = 'django-insecure-a$*aw1e_+ucf#2e9h!277=wdgak@jih=s2#vj0zq6o_s54hy24'
...
LOGGING_CONFIG_PATH = os.path.join(BASE_DIR, "logging_config.yaml")

with open(LOGGING_CONFIG_PATH, "r") as file:
    LOGGING = yaml.safe_load(file)
